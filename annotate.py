...
parser = argparse.ArgumentParser(prog='annotate',
                                    ...
                                    description='Masking/Annotaion program')
parser.add_argument("-d", "--imgs_dir",
                    help="Images Folder Path")
parser.add_argument("-n", "--save_neg", action="store_true", default=False,
...
print os.path.join(data_folder, 'DJI*.JPG')
